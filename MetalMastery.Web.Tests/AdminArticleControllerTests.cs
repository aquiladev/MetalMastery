...
namespace MetalMastery.Web.Tests
{
    ...
    public class AdminArticleControllerTests
    {
        ...
        [Test]
        public void Edit_ArticleDidntFound_Error()
        {
            var id = Guid.NewGuid();
            ...
            Assert.AreEqual(((ViewResultBase)result).ViewBag.Error, MmResources.ArticleDidntFound);
            Assert.IsNull(((ViewResultBase)result).Model);
        }
        ...
        [Test]
        public void Delete_ArticleDidntFound_Error()
        {
            using (_mockRepository.Record())
            {
                _articleService.Stub(x => x.GetArticleById(Guid.NewGuid()))
        ...
        [Test]
        public void DeleteConfirmed_ArticleDidntFound_Error()
        {
            using (_mockRepository.Record())
            {
                _articleService.Stub(x => x.GetArticleById(Guid.NewGuid()))
        ...
        public void CreatePost_UserNotFound_Error()
        {
            ...
            Assert.AreEqual(((ViewResultBase)result).ViewBag.Error, MmResources.UserDidntFound);
            Assert.IsNotNull(((ViewResultBase)result).Model);
        }
